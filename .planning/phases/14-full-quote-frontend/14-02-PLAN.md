...
4. **Form fields (in order):**
   ...
   - ComplexityPresets component (integrated with form state)
...
6. **Render:**
   ...
   - QuoteResult component when result exists

7. **Complexity integration:**
   - Use Controller for ComplexityPresets to integrate with react-hook-form
   - When preset changes, update all 6 factor fields
